...
<style>
    ...
    .hero-section {
        position: relative;
        background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('{{ asset('images/burger.jpeg') }}');
...
<section class="hero-section" data-aos="fade-up" data-aos-duration="1000">
    <div class="container px-4 px-md-5">
        ...
        <a href="{{ route('reservasi.index') }}" class="btn btn-primary-custom btn-custom">Reserve Your Table</a>
    </div>
</section>
    ...
    <div id="restaurantCarousel" class="carousel slide rounded-3 shadow-sm" data-bs-ride="carousel" data-bs-interval="4000" data-aos="zoom-in" data-aos-delay="100">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('images/burger.jpeg') }}" class="d-block w-100 carousel-img" alt="Signature Burger">
            ...
            <div class="carousel-item">
                <img src="{{ asset('images/spicy_chicken.jpeg') }}" class="d-block w-100 carousel-img" alt="Spicy Chicken">
                <div class="carousel-caption">
            ...
            <div class="carousel-item">
                <img src="{{ asset('images/iced_mocha.jpeg') }}" class="d-block w-100 carousel-img" alt="Iced Mocha">
                <div class="carousel-caption">
        ...
        <div class="col" data-aos="fade-up" data-aos-delay="200">
            <div class="card h-100">
                <div class="card-body p-5 text-center d-flex flex-column align-items-center">
                    ...
                    <a href="{{ route('reservasi.index') }}" class="btn btn-primary-custom btn-custom mt-auto">Reserve Now</a>
                </div>
            </div>
        </div>
        <div class="col" data-aos="fade-up" data-aos-delay="300">
            <div class="card h-100">
                <div class="card-body p-5 text-center d-flex flex-column align-items-center">
                    ...
                    <a href="{{ route('menu.index') }}" class="btn btn-secondary-custom btn-custom mt-auto">View Menu</a>
                </div>
            </div>
        </div>
        <div class="col" data-aos="fade-up" data-aos-delay="400">
            <div class="card h-100">
                <div class="card-body p-5 text-center d-flex flex-column align-items-center">
                    ...
                    <a href="{{ route('lihat.reservasi') }}" class="btn btn-primary-custom btn-custom mt-auto">View Booking</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container text-md-left">
        <div class="row text-md-left text-center">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p><a href="{{ route('menu.index') }}" class="text-white text-decoration-none">Menu</a></p>
                <p><a href="{{ route('reservasi.index') }}" class="text-white text-decoration-none">Reservasi</a></p>
                <p><a href="{{ route('lihat.reservasi') }}" class="text-white text-decoration-none">Cek Booking</a></p>
            </div>
